			...
			<div class="col-lg-10 col-lg-offset-1">
				<div class="row">
					...
					<div class="col-md-4">
						...
						<p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum.</p>
						...
						<div class="respond-form-container">
							...
							<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
									...
									<div id="comment-form-elements" class="clearfix">
										<div class="row">
											<div class="col-md-6">
												...
												<input class="col-md-12" type="text" name="author" id="author" value="<?php echo esc_attr($comment_author); ?>" placeholder="<?php _e( 'Your Name*', 'bonestheme' ); ?>" tabindex="1" <?php if ($req) echo "aria-required='true'"; ?> />
											</div>

											<div class="col-md-6">
												<label for="email"><?php _e( 'Mail', 'bonestheme' ); ?> <?php if ($req) _e( '(required)'); ?></label>
												<input class="col-md-12" type="email" name="email" id="email" value="<?php echo esc_attr($comment_author_email); ?>" placeholder="<?php _e( 'E-Mail*', 'bonestheme' ); ?>" tabindex="2" <?php if ($req) echo "aria-required='true'"; ?> />
											</div>
										</div><!--row-->
									</div>
								...
								<?php endif; ?>
									...
									<p>
										<input name="submit" type="submit" id="submit" class="btn btn-default" tabindex="5" value="<?php _e( 'Submit', 'bonestheme' ); ?>" />
